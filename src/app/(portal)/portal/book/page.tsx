    ...
    <div className="max-w-xl space-y-4">
      ...
      <Card>
        <form action={requestAppointment} className="space-y-4">
          ...
          <label className="flex items-center gap-2 text-sm"><input type="checkbox" name="dropOff" value="true" defaultChecked className="accent-[var(--accent)]" /> {s.terms.dropOff}</label>
