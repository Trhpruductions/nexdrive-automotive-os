...
const PUBLIC = ["/login", "/signup", "/forgot-password", "/reset-password", "/book", "/pay", "/api/stripe", "/api/twilio", "/suspended", "/approve", "/pricing", "/contact", "/terms", "/privacy", "/api/files", "/api/ingest", "/api/v1", "/api/health", "/brand", "/marketing", "/icon.png", "/manifest.webmanifest"];
